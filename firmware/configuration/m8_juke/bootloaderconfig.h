 ...
 * 
 * Controller type: AMega8 - 16 MHz
 * Configuration:   Jukebox
 *       USB D- :   PD4
 *       USB D+ :   PD2
 *       Entry  :   Button PC5 (PC0..PC5)
 *       LED    :   PD6 (SCK)
 *       OSCCAL :   Stays at 16 MHz
 * Note: Uses 16 MHz V-USB implementation with Crystal
 * Last Change:     Mar 16,2017
 *
...
#define JUMPER_PIN    PC0
#define JUMPER_PORT   PORTC
#define JUMPER_DDR    DDRC
#define JUMPER_INP    PINC 
